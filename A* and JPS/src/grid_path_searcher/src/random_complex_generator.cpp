...
void Savepcd()
{
   ...
   if (!cloudMap.empty())
   {
      string filename = "/home/sudaxia/ROSTEMPLATE/HW_2/src/grid_path_searcher/src/Binary.pcd";
      writer.write(filename, cloudMap, true);
...
void loadpcd()
{
   ...
   string file_name = "/home/sudaxia/ROSTEMPLATE/HW_2/src/grid_path_searcher/src/Binary.pcd";
